...
{
    /// <summary>
    /// Metodos que nos debe garantizar un repositorio de entidades
    /// </summary>
    public partial interface IRepositorio : IDisposable
	{
		//QueryResponse<T> Consultar<T>(IQueryDb<T> consulta, IRequest request);
        //QueryResponse<T> Consultar<T>(IQueryData<T> modelo, IRequest peticion, IEnumerable<T>  source, bool ignoreMaxLimit = false);
        ...
        /// <param name="predicado"></param>
        /// <returns></returns>
        T ConsultarSimple<T>(Expression<Func<T, bool>> predicado);
        ...
        int Actualizar<T>(T data,  Expression<Func<T, object>> onlyFields, Expression<Func<T, bool>> predicate);
        ...
        int Borrar<T>(int id) where T : IHasId<int>;
        ...
        /// <param name="data"></param>
        /// <returns>Numero de registros borrados (0 o 1)</returns>
        int Borrar<T>(T data) where T : IHasId<int>;
        ...
        int Borrar<T>(Expression<Func<T, bool>> predicado); 
